...
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lucide-react */ "./node_modules/lucide-react/dist/esm/icons/gift.js");
...
const CheckoutBar = ({
  ...
  const {
    ...
    wc_price
  } = (0,store__WEBPACK_IMPORTED_MODULE_1__["default"])(state => ({
  ...
  const [checkoutUrl, setCheckoutUrl] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)("");
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    // Replace 'checkout' with the slug or ID of your Checkout page
    const pageSlug = "cart";

    // Fetch the Checkout page details from the REST API
    fetch(`${window.location.origin}/wp-json/wp/v2/pages?slug=${pageSlug}`).then(response => response.json()).then(pages => {
      if (pages.length > 0) {
        setCheckoutUrl(pages[0].link);
      }
    }).catch(error => console.error("Error fetching the Checkout page:", error));
  }, []);
  const [showTooltip, setShowTooltip] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const handleClick = e => {
    if (totalQuantity === 0) {
      e.preventDefault();
      setShowTooltip(true);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, showTooltip && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-full px-4 py-0 mb-2 text-red-500 bg-white border border-blue-500 rounded bottom-full"
  }, "J\u016Bs\u0173 krep\u0161elis yra tu\u0161\u010Dias"), totalSalePriceMinusShipping > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "flex items-center justify-end px-3 py-0 mb-1 bg-white border border-gray-400 rounded float-end w-fit"
  }, "Pristatymas", " ", shippingTotal > 0 ? shippingTotal + " €" : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "contents text-[#23b500]"
  }, "nemokamas", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "ml-0.5"
    ...
    className: "flex items-center justify-between w-full px-3 py-4 text-lg text-white no-underline bg-blue-500 rounded gap-x-1"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "flex items-center"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "flex items-center justify-center w-6 h-6 mr-2 bg-white rounded-full text-sky-900"
  }, totalQuantity), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "leading-5 "
  }, "Pirkini\u0173 krep\u0161elis")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, totalSalePriceMinusShipping, " ", currencyData.currency_symbol)))));
};
...
if (htmlElement) {
  ReactDOM.createRoot(htmlElement).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(CheckoutBar, {
    data: jsonData
  }));
}
})();
