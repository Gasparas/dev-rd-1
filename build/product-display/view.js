...
function AdjusterBox({
  ...
  const {
    ...
    isLoading,
    error
  } = (0,store__WEBPACK_IMPORTED_MODULE_4__["default"])(state => ({
  ...
  const [value, setValue] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(initialValue);
...
function ProductDisplay({
  ...
  const [counterValue, setCounterValue] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(0);
  const {
