...
new CounterInstance(controllerA, 'group_a', 0, 0, { min: 0, max: 3 });
new CounterInstance(controllerA, 'group_a', 1, 0, { min: 0, max: 4 });
new CounterInstance(controllerA, 'group_a', 2, 0, { min: 0, max: 4 });
new CounterInstance(controllerA, 'group_a', 3, 0, { min: 0, max: 4 });
// Add more instances as needed...

const controllerB = new Controller('group_b');
new CounterInstance(controllerB, 'group_b', 0, 0, { min: 0, max: 3 });
new CounterInstance(controllerB, 'group_b', 1, 0, { min: 0, max: 4 });
new CounterInstance(controllerB, 'group_b', 2, 0, { min: 0, max: 4 });
// Add more instances as needed...
